...
function xetDiemTuyenSinh() {
  ...
  if (diemChuan == 0) {
    ...
    ketQuaThiSinh =
      "Rớt. Bạn nhập thiếu điểm môn học hoặc có môn học điểm số bé hơn hoặc bằng 0";
  } else {
  ...
  document.getElementById("txtKetQuaThiSinh").innerHTML =
    ketQuaThiSinh + ". Tổng điểm của bạn = " + diemTong;
}
